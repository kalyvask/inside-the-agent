...
# v0.24-D: prefer the committed artifacts/results/ snapshot so a clean clone
# can regenerate the report without needing data/results/ (gitignored scratch).
_COMMITTED = Path("artifacts/results")
_SCRATCH = Path("data/results")
RESULTS_DIR = _COMMITTED if _COMMITTED.exists() else _SCRATCH
...
def main() -> int:
    ...
    parts.append(
        ...
        f"This file is regenerated from `{RESULTS_DIR.as_posix()}/*.jsonl`. **Do not edit by "

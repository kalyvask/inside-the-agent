...
- **Effort over time.** A ~13-day CS153 build sprint. The full commit history is public; the version progression (controls, strict-vs-lenient scoring, the executed-action diagnostic, honesty fixes) shows the project tightening round by round.
